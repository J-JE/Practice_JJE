...
import com.hw1.model.vo.Product_guide;

public class ProductTest_guide {

	public static void main(String[] args) {

		// 1. 매개변수 생성자를 이용하여 3개의 객체 생성 후 출력
		Product_guide pro1 = new Product_guide("ssgnote9", "갤럭시노트9", "경기도 수원", 960000, 10.0);
		Product_guide pro2 = new Product_guide("lgxnote5", "LG스마트폰5", "경기도 평택", 780000, 0.7);
		Product_guide pro3 = new Product_guide("ktsnote3", "KT스마트폰3", "서울시 강남", 250000, 0.3);
