package com.kh2.collection.silsub1.view;

import java.util.Scanner;

import com.kh2.collection.silsub1.controller.BoardManager;

public class BoardMenu {
	private Scanner sc = new Scanner(System.in);
	private BoardManager bm = new BoardManager();
	
	public BoardMenu() { } //기본 생성자
	
	public void mainMenu() {
		//게시글 프로그램에 해당하는 메인 메뉴 출력, 각 메뉴에 해당하는 BoardManager 클래스의
		//메소드 실행 반복 출력되게 함
		while(true) {
			...
			case 10 : System.out.println("프로그램이 종료 되었습니다."); return;
	...
	public void sortSubMenu() {
		//메인 메뉴의 9번을 눌렀을 때출력되는 서브 메뉴
		//각 서브 메뉴에 해당하는BoardManager 클래스의 메소드 실행
		//반복 출력되게 함
		while(true) {
