...
public class Member implements Serializable{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3852614337102436431L;
	...
	//1. 필드변수 컬럼에 대응~
		...
		public Member(String userId, String password, String userName, String gender, int age, String email, String phone,
				String address, String hobby, Date enrollDate, Date delDate) {
			this(userId, password, userName, gender, age, email, phone, address, hobby, enrollDate);
		...
		public String printDeleteMemeber() {
			return userId+", "+password+", "+userName+", "+gender +", "+age 
					+", "+email+", "+phone+", "+address+", "+hobby +", "+enrollDate+", "+delDate;
		}
}
