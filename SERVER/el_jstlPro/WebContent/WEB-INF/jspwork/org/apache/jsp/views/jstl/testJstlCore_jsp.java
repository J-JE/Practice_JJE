 ...
 * Generated at: 2022-04-01 10:57:24 UTC
...
public final class testJstlCore_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("jar:file:/D:/Study-JJE/SERVER/el_jstlPro/WebContent/WEB-INF/lib/jstl-1.2.jar!/META-INF/c.tld", Long.valueOf(1153352682000L));
    _jspx_dependants.put("/WEB-INF/lib/jstl-1.2.jar", Long.valueOf(1648713809096L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("	<p>\r\n");
      out.write("		JSTL을 사용 하고자 하는 JSP 페이지의 상단 <br>\r\n");
      out.write("		page 지시자 아래에 taglib 지시자를 사용하여 선언해야됨 <br><br>\r\n");
      out.write("		\r\n");
      out.write("		&lt;%@ taglib prefix=\"사용하고자 하는 접두사\" uri=\"tld 파일상의 uri\" %&gt;\r\n");
      out.write("		\r\n");
      out.write("		<br>\r\n");
      out.write("		prefix : 접두사. 다른 태그와 구별할 수 있는 name space를 제공함. <br>\r\n");
      out.write("		uri : 실제 웹 상의 주소가 아닌, 태그 라이브러리를 나타내는 식별자. <br>\r\n");
      out.write("			  tld파일 상에 uri 값을 가리키며, <br>\r\n");
      out.write("			    이 지시자를 통해 작성한 태그 이름과 매칭되는 자바코드를 찾음 <br>\r\n");
      out.write("		\r\n");
      out.write("		* tld (Tag Library Descriptor) 파일 : 커스텀 태그 정보를 갖고 있는 라이브러리 파일\r\n");
      out.write("		* uri (Uniform Resource Identifier) : 자원을 나타내는 유일한 주소\r\n");
      out.write("		\r\n");
      out.write("	</p>\r\n");
      ...
      out.write("	- 변수 선언 시 scope를 지정할 수 있음. 기본 scope는 pageScope\r\n");
      out.write("	- 사용 방법\r\n");
      out.write("	  1) 변수 타입은 별도로 선언하지 않는다.\r\n");
      out.write("	  2) 초기값은 반드시 지정해야된다.\r\n");
      out.write("	  3) c:set 태그로 선언한 변수는 EL안에서 사용 가능\r\n");
      out.write("	         하지만 스크립틀릿 요소에서는 사용할 수 없음.\r\n");
      out.write("	</pre>\r\n");
 ...
 int num3 = 10, num4 = 20; 
      ...
      try {
        ...
        // /views/jstl/testJstlCore.jsp(52,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_c_005fset_005f3.setVar("sum2");
        // /views/jstl/testJstlCore.jsp(52,1) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      ...
      out.write("<br>\r\n");
      out.write("	\r\n");
      out.write("	<h2>c:set 태그 : 배열로 사용할 문자열을 선언</h2>\r\n");
      out.write("	");
      if (_jspx_meth_c_005fset_005f4(_jspx_page_context))
        return;
      out.write("\r\n");
      out.write("	\r\n");
      out.write("	colors 값 확인 : 	");
      ...
      out.write("	&lt;, &gt;, & 특수문자를 자동으로 \r\n");
      out.write("	이스케이프 시퀀스(escape sequence)로 변환 가능.\r\n");
      out.write("	</pre>\r\n");
      out.write("	\r\n");
      out.write("	");
      ...
      out.write("\r\n");
      out.write("	\r\n");
      out.write("	<h2>이스케이프 시퀀스 : <, >, & 등의 특수문자를 &lt;, &gt; &amp;로 바꿔서 인식시킨다.</h2>\r\n");
      out.write("	\r\n");
      out.write("	");
      ...
      out.write("	- 위의 태그 사용시 조건식은 test라는 속성의 값으로 지정해야됨\r\n");
      out.write("	  이때 조건식은 반드시 EL형식으로 기술해야됨\r\n");
      out.write("	</pre>\r\n");
      out.write("	\r\n");
      out.write("	");
      ...
      out.write("	<pre>\r\n");
      out.write("	- Java의 if-else if문 또는 switch문과 비슷한 역할을 하는 태그<br>\r\n");
      out.write("	- 각 조건들은 c:choose문의 하위요소로 c:when 를 통해서 작성 (default 값으로는  c:otherwise)\r\n");
      out.write("	</pre>\r\n");
      out.write("	\r\n");
      out.write("	");
      ...
      out.write("\r\n");
      out.write("	\r\n");
      out.write("	<h2>c:forEach 태그 : for문</h2>\r\n");
      out.write("	<h3>4. 반복문 - forEach (c:forEach var=\"\" begin=\"\" end=\"\" step=\"\" items=\"\" varStatus=\"\") </h3>\r\n");
      out.write("	<pre>\r\n");
      out.write("	&lt;c:forEach&gt; 반복시 실행할 내용 &lt;/c:forEach&gt;\r\n");
      out.write("	- Java의 for문에 해당하는 기능을 제공.\r\n");
      out.write("	- forEach문은 여러가지 속성이 사용됨.\r\n");
      out.write("	\r\n");
      out.write("	var : 현재 반복 횟수에 해당하는 변수의 이름\r\n");
      out.write("	begin : 반복이 시작할 요소 번호(0 ... n)\r\n");
      out.write("	end : 반복이 끝나는 요소 번호\r\n");
      out.write("	step : 반복 시 증가할 수\r\n");
      out.write("	items : 반복할 객체 명(Collection 객체)\r\n");
      out.write("	varStatus : 현재 반복에 해당하는 객체의 요소 정보\r\n");
      out.write("	</pre>\r\n");
      out.write("	");
      ...
      out.write("	\r\n");
      out.write("	\r\n");
      out.write("	<h2>c:forEach태그 : 배열 또는 컬렉션 연속처리에 for ~ each문 처럼 사용 가능하다.</h2>\r\n");
      out.write("	");
      ...
      out.write("	\r\n");
      out.write("	\r\n");
      out.write("	<h2>c:forTokens 태그 : 문자열을 토큰으로 분리처리 할 때 사용</h2>\r\n");
      out.write("	<pre>\r\n");
      out.write("	- 문자열에 포함된 구분자를 통해 토큰을 분리해서 반복 처리\r\n");
      out.write("	- Java의 Stinrg.split() 또는 StringTokenizer와 비슷한 기능\r\n");
      out.write("	- items 속성에는 토큰을 포함하는 문자열을 지정하고,\r\n");
      out.write("	  delims 속성에는 토큰을 분리하는데 사용할 구획 문자를 기술. \r\n");
      out.write("	</pre>\r\n");
      out.write("	<ul>\r\n");
      out.write("		");
      ...
      out.write("	</ul>\r\n");
      out.write("	\r\n");
      out.write("	<h3>여러 개의 토큰 문자를 가지고 분리할 수 도 있다.</h3>\r\n");
      out.write("	");
      ...
      out.write("\r\n");
      out.write("	<a href=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${fmtlink}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("\">결과화면 연결</a>\r\n");
      out.write("</body>\r\n");
      out.write("</html>");
  ...
  private boolean _jspx_meth_c_005fset_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      _jspx_th_c_005fset_005f0.setValue(new org.apache.jasper.el.JspValueExpression("/views/jstl/testJstlCore.jsp(42,1) '100'",_jsp_getExpressionFactory().createValueExpression("100",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /views/jstl/testJstlCore.jsp(42,1) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(43,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f1.setVar("num2");
      // /views/jstl/testJstlCore.jsp(43,1) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f1.setValue(new org.apache.jasper.el.JspValueExpression("/views/jstl/testJstlCore.jsp(43,1) '200'",_jsp_getExpressionFactory().createValueExpression("200",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /views/jstl/testJstlCore.jsp(43,1) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(45,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f2.setVar("sum");
      // /views/jstl/testJstlCore.jsp(45,1) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f2.setValue(new org.apache.jasper.el.JspValueExpression("/views/jstl/testJstlCore.jsp(45,1) '${num1+num2}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${num1+num2}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fset_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(57,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      if (_jspx_eval_c_005fset_005f4 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        ...
        do {
          out.write("\r\n");
          out.write("		red, yellow, green, orange, blue, magenta\r\n");
          out.write("	");
  ...
  private boolean _jspx_meth_c_005fremove_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(79,1) name = var type = java.lang.String reqTime = false required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fremove_005f0.setVar("num1");
      // /views/jstl/testJstlCore.jsp(79,1) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(96,1) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(98,1) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fout_005f1.setValue("<h2>데이터출력</h2>");
      // /views/jstl/testJstlCore.jsp(98,1) name = escapeXml type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f3(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(103,1) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      // /views/jstl/testJstlCore.jsp(103,1) name = default type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      _jspx_th_c_005fset_005f5.setValue(new org.apache.jasper.el.JspValueExpression("/views/jstl/testJstlCore.jsp(113,1) '9'",_jsp_getExpressionFactory().createValueExpression("9",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /views/jstl/testJstlCore.jsp(113,1) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f6(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(114,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f6.setVar("value2");
      // /views/jstl/testJstlCore.jsp(114,1) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f6.setValue(new org.apache.jasper.el.JspValueExpression("/views/jstl/testJstlCore.jsp(114,1) '30'",_jsp_getExpressionFactory().createValueExpression("30",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /views/jstl/testJstlCore.jsp(114,1) name = scope type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f4(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(115,12) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f5(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(116,12) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(118,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(119,21) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fif_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(122,1) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fout_005f7(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fif_005f1, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(123,21) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fset_005f7(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(133,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f7.setVar("no");
      // /views/jstl/testJstlCore.jsp(133,1) name = value type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fset_005f7.setValue(new org.apache.jasper.el.JspValueExpression("/views/jstl/testJstlCore.jsp(133,1) '${param.no}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${param.no}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
  ...
  private boolean _jspx_meth_c_005fout_005f8(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(134,14) name = value type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fwhen_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(137,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fwhen_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005fchoose_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(140,2) name = test type = boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(162,1) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f0.setBegin(1);
      // /views/jstl/testJstlCore.jsp(162,1) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(168,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setVar("size");
      // /views/jstl/testJstlCore.jsp(168,1) name = begin type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setBegin(1);
      // /views/jstl/testJstlCore.jsp(168,1) name = end type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f1.setEnd(7);
      // /views/jstl/testJstlCore.jsp(168,1) name = step type = int reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforEach_005f2(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(174,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setVar("color");
      // /views/jstl/testJstlCore.jsp(174,1) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
      _jspx_th_c_005fforEach_005f2.setItems(new org.apache.jasper.el.JspValueExpression("/views/jstl/testJstlCore.jsp(174,1) '${colors }'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${colors }",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
      // /views/jstl/testJstlCore.jsp(174,1) name = varStatus type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforTokens_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(187,2) name = items type = javax.el.ValueExpression reqTime = true required = true fragment = false deferredValue = true expectedTypeName = java.lang.String deferredMethod = false methodSignature = null
      _jspx_th_c_005fforTokens_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/views/jstl/testJstlCore.jsp(187,2) 'yellow blue pink red green'",_jsp_getExpressionFactory().createValueExpression("yellow blue pink red green",java.lang.String.class)).getValue(_jspx_page_context.getELContext()));
      // /views/jstl/testJstlCore.jsp(187,2) name = delims type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforTokens_005f0.setDelims(" ");
      // /views/jstl/testJstlCore.jsp(187,2) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fforTokens_005f1(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(193,1) name = items type = javax.el.ValueExpression reqTime = true required = true fragment = false deferredValue = true expectedTypeName = java.lang.String deferredMethod = false methodSignature = null
      _jspx_th_c_005fforTokens_005f1.setItems(new org.apache.jasper.el.JspValueExpression("/views/jstl/testJstlCore.jsp(193,1) 'yellow-blue*pink/red green'",_jsp_getExpressionFactory().createValueExpression("yellow-blue*pink/red green",java.lang.String.class)).getValue(_jspx_page_context.getELContext()));
      // /views/jstl/testJstlCore.jsp(193,1) name = delims type = java.lang.String reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fforTokens_005f1.setDelims("*/ -");
      // /views/jstl/testJstlCore.jsp(193,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005furl_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(198,1) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005furl_005f0.setVar("fmtlink");
      // /views/jstl/testJstlCore.jsp(198,1) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_c_005fparam_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_005furl_005f0, javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /views/jstl/testJstlCore.jsp(199,2) name = name type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_c_005fparam_005f0.setName("num");
      // /views/jstl/testJstlCore.jsp(199,2) name = value type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
